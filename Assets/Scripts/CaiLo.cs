...
public class CaiLo : MonoBehaviour
{
	private void Hit(Vector2 p)
	{
		if (this.loai == CaiLo.LoaiChum.Tien)
		{
			if (!this.tienTo)
			{
				if (this.tuiTien)
		...
		else if (this.loai == CaiLo.LoaiChum.Enemy)
		{
		...
		else if (this.loai == CaiLo.LoaiChum.Bonus)
		{
		...
		else if (this.loai == CaiLo.LoaiChum.PhiTieu)
		{
			if (this.phiTieu)
			{
		...
		else if (this.loai == CaiLo.LoaiChum.Special && this.spec)
		{
	...
	{
		GameObject.FindGameObjectWithTag("Effect").GetComponent<EffectController>().ToeSu(base.gameObject.transform.position);
		if (this.loai == CaiLo.LoaiChum.Tien)
		{
			if (!this.tienTo)
			{
