...
public class SmoothCameraOrbit : MonoBehaviour
{
	...
	private void LateUpdate()
	{
		...
		{
			this.desiredDistance -= UnityEngine.Input.GetAxis("Mouse Y") * Time.deltaTime * (float)this.zoomRate * 0.125f * Mathf.Abs(this.desiredDistance);
		}
		...
		this.desiredDistance -= UnityEngine.Input.GetAxis("Mouse ScrollWheel") * Time.deltaTime * (float)this.zoomRate * Mathf.Abs(this.desiredDistance);
