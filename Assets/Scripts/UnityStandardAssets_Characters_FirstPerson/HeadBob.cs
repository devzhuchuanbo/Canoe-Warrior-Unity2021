...
namespace UnityStandardAssets.Characters.FirstPerson
{
	public class HeadBob : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			{
				this.Camera.transform.localPosition = this.motionBob.DoHeadBob(this.rigidbodyFirstPersonController.Velocity.magnitude * ((!this.rigidbodyFirstPersonController.Running) ? 1f : this.RunningStrideLengthen));
